...
namespace MySpotify.Idp.IdentityServerConfiguration
{
    public class IdentityServerConfiguration
    {
        ...
        public static IEnumerable<ApiResource> GetApiResources()
        {
            ...
            {
                new ApiResource("MySpotify", "Infnet Arquitetura", new string[] { "user", "admin" })
                {
                    ApiSecrets =
                    {
        ...
        public static IEnumerable<Client> GetClients()
        {
            return new List<Client>
            {
                new Client()
                {
                    ...
                    ClientName = "MySpotify Service Token",
